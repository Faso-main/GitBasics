...
from LM.Res import save_results, results, Developer_mode, Train_new_model, Load_from_huggingface_model, SERVER_TIME
...
class BertTrainer:
    ...
    def postprocess(self, val_questions, val_answers, train_loss, epoch_num):
        ...
        save_results(epoch_num, train_loss, val_accuracy, f1, memory_usage, base_dir)
